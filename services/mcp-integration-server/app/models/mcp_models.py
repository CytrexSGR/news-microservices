...
class MCPTool(BaseModel):
    ...
    name: str = Field(..., description="Tool name (e.g., 'get_market_quote')")
    ...
    category: str = Field(..., description="Tool category (market, research, notification)")
...
class ToolsListResponse(BaseModel):
    ...
    server: str = Field(default="mcp-integration-server", description="MCP server name")
