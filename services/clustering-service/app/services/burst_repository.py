...
class BurstRepository:
    ...
    async def record_burst_alert(
        ...
        Args:
            ...
            top_entities: Top entities in the cluster
            first_article_at: Timestamp of first article in cluster
            last_article_at: Timestamp of most recent article in cluster
        ...
        logger.info(
            ...
            f"velocity={velocity} category={category}"
        )
