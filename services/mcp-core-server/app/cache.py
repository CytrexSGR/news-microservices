"""Redis cache manager for MCP Core Server."""
...
class CacheManager:
    ...
    Provides caching functionality for MCP Core Server to reduce
    load on backend services and improve response times.

    Cache Strategy:
    - SHORT (1min):   Session tokens, real-time metrics
    - MEDIUM (5min):  Analytics overview, dashboard data
    - LONG (30min):   User profiles, service health
    """
